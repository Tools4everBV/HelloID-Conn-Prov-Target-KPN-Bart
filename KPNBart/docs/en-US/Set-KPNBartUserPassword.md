...
```
Set-KPNBartUserPassword [-Identity] <String> [-Password] <SecureString> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### -Identity
The Identity of the user for whom you want to update the password.
